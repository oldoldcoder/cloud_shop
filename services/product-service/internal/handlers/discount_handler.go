...
type DiscountHandler struct{ svc *services.DiscountService }

func NewDiscountHandler() *DiscountHandler {
	return &DiscountHandler{svc: services.NewDiscountService()}
}
...
func (h *DiscountHandler) ListByProduct(c *gin.Context) {
